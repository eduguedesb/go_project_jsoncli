Neste projeto, eu usei o pacote jsonparser, que oferece funções em Go para manipulação de dados JSON, facilitando operações de leitura, filtragem, formatação e gravação de arquivos JSON.
